...
def create_app():
    ...
    from routes.v1.media.media_download import v1_media_download_bp
    from routes.v1.media.media_proxy import v1_media_proxy_bp
    ...
    app.register_blueprint(v1_media_proxy_bp)
